...
export function useElements (theWinnerIs, setParcialResult, scored, setScored, setInput, input, letterPlayer1, setLetterPlayer1, letterPlayer2, setLetterPlayer2) {
